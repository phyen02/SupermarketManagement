    ...
    public partial class PhieuNhap : Form
    {
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                key = c * d;
                string sql1 = "Insert into phieunhap1 values('" + txt_mancc.SelectedValue + "','" + txt_mathuoc.Text + "','" + txt_solg.Text + "',N'" + txt_dvt.Text + "', '" + txt_gianhap.Text + "',N'" + txt_tennv.Text + "','" + txt_ngaynhap.Value + "','" + key.ToString() + "','" + txt_congno.Text + "','" + tt + "' )";
        ...
        private void dta1_Click(object sender, EventArgs e)
        {
            ...
            tenbang();
            MessageBox.Show(txt_ngaynhap.Text.ToString());
        ...
        {
            string s = "true";
            string sql = "Update phieunhap1 set trangthai='" + s + "'  WHERE mahdn ='" + txt_mhd.Text + "'";
            ...
            dta2.Columns[2].HeaderText = "Guá nhập"; dta2.Columns[2].Width = 120;
